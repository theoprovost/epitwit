...
@section('content')
<div class="container text-gray-300  h-screen flex justify-center">
    <div class="flex-col flex content-center  justify-center content-center">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary border p-2 mt-4">
                                    {{ __('Login') }}
                                </button>
